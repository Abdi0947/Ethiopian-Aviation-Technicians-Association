          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Ethiopian Aviation
                <span className="block text-primary-200">Technicians Association</span>
              </h1>
              <p className="text-xl md:text-2xl text-primary-100 max-w-2xl">
                Advancing aviation safety and excellence through professional development, 
                training, and collaboration among Ethiopian aviation technicians.
              </p>
            </div>
            ...
            <div className="relative z-10">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                <div className="text-center space-y-4">
                  <Plane className="h-16 w-16 mx-auto text-primary-200" />
